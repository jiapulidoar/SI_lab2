...
class TripController {
    ...
    def index(Integer max) {
        ...
        def tripList = tripService.list (params) {
            if ( params.query ) {
                ilike("airline", "%${params.query}%")
            }
        }

        [tripInstanceList: tripList, tripInstanceTotal: tripList.totalCount]
    }
    ...
    def search(){
        def results = Trip.findAllByAirline("%Test%")
